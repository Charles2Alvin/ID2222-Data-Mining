...
//  private float TEMPERATURE = 2;//default
  private float TEMPERATURE = 1;//improved algorithm

  @Option(name = "-delta", usage = "Simulated annealing delta.")
//  private float DELTA = (float) 0.003;//default
  private float DELTA = (float) 0.8;//improved algorithm
